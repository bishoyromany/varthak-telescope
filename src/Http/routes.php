...
// Requests entries...
Route::any('/telescope-api/requests', 'RequestsController@index');
Route::any('/telescope-api/esandhai/requests', 'RequestsController@index')->name("telescope-api.requests");
